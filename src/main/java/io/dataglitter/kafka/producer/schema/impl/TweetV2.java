 ...
 */
@Component
public class TweetV2 implements SchemaAdaptor<Schema, Status, GenericRecord> {
    ...
    public TweetV2(@Value("classpath:schema/tweet-v2.avsc") Resource tweetSchema) throws Exception {
    ...
    public GenericRecord populateRecord(Status status) {
        ...
        tweet.put(TweetConstants.TWEETED_ON, status.getCreatedAt().toString());
        return tweet;
    }
